...
var CreatePage = function CreatePage(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("http://35.229.209.76/api/v1/contracts?limit=300&offset=0").then(function (data) {
      setContracts(data.contracts.reduce(function (p, _ref) {
        var contractAddress = _ref.contractAddress,
            c = _objectWithoutProperties(_ref, ["contractAddress"]);
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    if (props.selectedAddress !== _utils_constants__WEBPACK_IMPORTED_MODULE_5__["NULL_ADDRESS"]) {
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("http://35.229.209.76/api/v1/assets?ownerAddress=".concat(props.selectedAddress)).then(function (data) {
...
//# sourceMappingURL=create.js.a9ba28948a47155241b9.hot-update.js.map